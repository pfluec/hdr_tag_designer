...
def guides_csv(result: DesignResult) -> str:
    ...
    fields = [
        ...
        "recuttable_site_present",
        "recuttable_site_matches",
        "original_spacer_pam_contiguous_after_edit",
        "junction_recreated_target",
        "blocking_mutation_reason",
        ...
        writer.writerow(
            {
                ...
                "recuttable_site_present": guide.recuttable_site_present,
                "recuttable_site_matches": json.dumps(guide.recuttable_site_matches, sort_keys=True),
                "original_spacer_pam_contiguous_after_edit": guide.original_spacer_pam_contiguous_after_edit,
                "junction_recreated_target": guide.junction_recreated_target,
                "blocking_mutation_reason": guide.blocking_mutation_reason,
...
def _guide_report(guide: GuideCandidate) -> list[str]:
    return [
        ...
        f"  Longest PAM-proximal matching segment in any final PAM-adjacent candidate: {guide.final_longest_retained_segment} nt",
        f"  Recuttable PAM-adjacent site present: {'yes' if guide.recuttable_site_present else 'no'}",
        f"  Original spacer/PAM contiguous after edit: {'yes' if guide.original_spacer_pam_contiguous_after_edit else 'no'}",
        f"  Target recreated across an insertion junction: {'yes' if guide.junction_recreated_target else 'no'}",
        f"  Blocking decision reason: {guide.blocking_mutation_reason or '(none)'}",
